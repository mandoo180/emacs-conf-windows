...
(defun hasliberg-theme--update-standard-faces ()
  (custom-theme-set-faces
   ...
   `(org-drawer ((t :inherit (default font-lock-comment-face))))
   `(org-property-value ((t :inherit (default font-lock-comment-face))))
   `(org-tag ((t :inherit default :height 0.7)))
...
(defun hasliberg-theme--update-org-related-faces ()
 (custom-theme-set-faces
  ...
  `(org-modern-todo ((t :inherit default
                        :background ,(hasliberg-theme-hex-for 'primary-600))))
  `(org-modern-symbol ((t :inherit default
